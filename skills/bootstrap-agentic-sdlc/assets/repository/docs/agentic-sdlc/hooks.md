<!-- agentic-sdlc:managed hooks/v2 -->
# Native task-boundary hook guardrails

Agentic SDLC does not install a plugin-global hook. Bootstrap and upgrade manage .codex/hooks.json, scripts/pretool_handoff_guard.py, and scripts/validate_hooks.py only inside an adopted Agentic SDLC repository. This prevents an enabled plugin from applying Agentic SDLC policy to unrelated projects.
